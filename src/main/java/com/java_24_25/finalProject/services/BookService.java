...
public class BookService {
    ...
    public Model calculatePrice(Model model, Book book) {
        ...
        double paperTypePrice = calculator.calculatePaperTypePrice(book.getPaperType(), book.getSize());
        double numberOfPagesPrice = calculator.calculateNumberOfPagesPrice(paperTypePrice, Integer.parseInt(book.getNumberOfPages()));

        double paperColorPrice = calculator.calculatePaperColorPrice(book.getPaperBaseColour(), book.getPaperType(), book.getSize(), Integer.parseInt(book.getNumberOfPages()));
